...
from dcp.auxnet.option import Option
...
class Experiment(object):
    ...
    def _load_pretrained(self):
        ...
        if self.settings.pretrained is not None:
            ...
            if 'state_dict' in check_point_params.keys():
                check_point_params = check_point_params['state_dict']
            # check_point_params = {k.replace('module.', ''): v for k, v in check_point_params.items() if 'module.' in k}
